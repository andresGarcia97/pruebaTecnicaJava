...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../account-bank.test-samples';

import { AccountBankService, RestAccountBank } from './account-bank.service';

const requireRestSample: RestAccountBank = {
