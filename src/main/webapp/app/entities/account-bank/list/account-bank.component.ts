...
import { EntityArrayResponseType, AccountBankService } from '../service/account-bank.service';
...
export class AccountBankComponent implements OnInit {
  ...
  trackId = (_index: number, item: IAccountBank): number => this.accountBankService.getAccountBankIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.accountBanks = this.refineData(dataFromBody);
  }

  protected refineData(data: IAccountBank[]): IAccountBank[] {
